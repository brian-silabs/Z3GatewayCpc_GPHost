...
#define GENERATED_CLUSTERS { \
  { 0x0000, (EmberAfAttributeMetadata*)&(generatedAttributes[0]), 1, 0, CLUSTER_MASK_CLIENT, NULL }, /* 0, Endpoint Id: 1, Cluster: Basic, Side: client*/ \
	  ...
	  { 0x0300, (EmberAfAttributeMetadata*)&(generatedAttributes[26]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 14, Endpoint Id: 1, Cluster: Color Control, Side: client*/ \
	  { 0x0300, (EmberAfAttributeMetadata*)&(generatedAttributes[27]), 13, 22, CLUSTER_MASK_SERVER, NULL }, /* 15, Endpoint Id: 1, Cluster: Color Control, Side: server*/ \
	  { 0x0400, (EmberAfAttributeMetadata*)&(generatedAttributes[40]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 16, Endpoint Id: 1, Cluster: Illuminance Measurement, Side: client*/ \
	  { 0x0402, (EmberAfAttributeMetadata*)&(generatedAttributes[41]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 17, Endpoint Id: 1, Cluster: Temperature Measurement, Side: client*/ \
	  { 0x0405, (EmberAfAttributeMetadata*)&(generatedAttributes[42]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 18, Endpoint Id: 1, Cluster: Relative Humidity Measurement, Side: client*/ \
	  { 0x0406, (EmberAfAttributeMetadata*)&(generatedAttributes[43]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 19, Endpoint Id: 1, Cluster: Occupancy Sensing, Side: client*/ \
	  { 0x0500, (EmberAfAttributeMetadata*)&(generatedAttributes[44]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 20, Endpoint Id: 1, Cluster: IAS Zone, Side: client*/ \
	  { 0x0702, (EmberAfAttributeMetadata*)&(generatedAttributes[45]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 21, Endpoint Id: 1, Cluster: Simple Metering, Side: client*/ \
	  { 0x0B01, (EmberAfAttributeMetadata*)&(generatedAttributes[46]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 22, Endpoint Id: 1, Cluster: Meter Identification, Side: client*/ \
	  { 0x0B03, (EmberAfAttributeMetadata*)&(generatedAttributes[47]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 23, Endpoint Id: 1, Cluster: Appliance Statistics, Side: client*/ \
	  { 0x0B04, (EmberAfAttributeMetadata*)&(generatedAttributes[48]), 1, 2, CLUSTER_MASK_CLIENT, NULL } /* 24, Endpoint Id: 1, Cluster: Electrical Measurement, Side: client*/ \
	 }
